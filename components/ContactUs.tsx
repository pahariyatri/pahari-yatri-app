                        ...
                        <div className="grid md:grid-cols-2">
                            <div className="h-full pr-6">
                                ...
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        <div
                                            className="flex h-10 w-10 items-center justify-center rounded bg-black  text-gray-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24"
                                                fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round"
                                                stroke-linejoin="round" className="h-6 w-6 dark:text-black">
                                    ...
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Mobile: +1 (123)
                                                456-7890</p>
                            ...
                            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                                ...
                                <form id="contactForm">
                                    ...
                                    <div className="text-center">
                                        <Button className=" font-bold py-3 px-6 rounded-full transition duration-300">Send Message</Button>
                                    </div>
                                </form>
                            </div>
                        </div>
