...
### 4.1 Addendum — 2026-09-09, second pass, requested as a profile-optimization check

Four things not caught in the first LinkedIn pass, checked directly this time via the Edit Page tabs (Buttons, Details, Locations) and the public "View as member" render:

- **The "Specialties" field lists: Trekking, Mountaineering, Camping, Adventure Tours, Cultural Immersion.** This is a sixth, independent place the "tour operator" identity is asserted — arguably the most concrete one yet, since it's tag-shaped, not prose, and four of five tags are trip/gear language with only one ("Cultural Immersion") gesturing at storytelling. It sits directly below the Overview in LinkedIn's own field order.
- **On the public page render, the Industry taxonomy sits directly under the tagline, in the same line a visitor reads first:** *"Not tourism. A movement of Yatri."* immediately followed by *"Travel Arrangements · Mandi, Himachal Pradesh · 77 followers · 2-10 employees."* The contradiction isn't buried in a settings tab — it's the first two lines of the page, adjacent, both visible before any scrolling.
- **A specific location is on record: "Mandi, Himachal Pradesh 175017, IN," set as Headquarters (Primary)** in the Locations tab. This is more specific than anything found on the GBP listing (service area only, no street address) — worth reconciling if GBP's address fields are ever completed, so the two don't quietly diverge.
- **Only one person is listed as an associated LinkedIn employee of Pahari Yatri, and they're based in West Bengal, not Himachal Pradesh** (per the People tab's "Where they live" breakdown). Not necessarily wrong — remote team members exist — but worth knowing going into the growth-strategy point about employee/founder reshares (`marketing/LINKEDIN_PLAN.md` §7): the realistic reshare network right now is the founder's own profile plus, at most, one other person.
- **A second, separate, near-empty LinkedIn page exists: "Pahari Yatri Expeditions"** (`linkedin.com/showcase/103036012`), listed as an Affiliated Page / Showcase page of the main company page. Checked directly: 1 follower, zero posts, no description set at all (LinkedIn's own "Add description" prompt is still showing), 41 search appearances in the last 7 days (down 41.4%). A LinkedIn Showcase Page is specifically the mechanism for a parent company to run a distinct sub-brand page — its existence suggests someone already had the instinct to split "storytelling brand" (main page) from "expeditions/trekking" (showcase page) at some point, then never built it out. **This is worth surfacing as a real option for the identity question in §9**, not just a stray finding: rather than resolving the tension by picking one identity for the single main page, the "both, with a boundary" option already has unused infrastructure to run on — the main page stays storytelling-first (matching its Overview/tagline, its best-aligned copy), and "Pahari Yatri Expeditions" becomes the honest home for the trekking-operator history and anything GBP-review-adjacent, linked from the main page rather than competing with it. Not a recommendation — a founder decision, same as everything else in §9 — but it changes the shape of that decision from "which one do we become" to "do we finish what's already half-built."
