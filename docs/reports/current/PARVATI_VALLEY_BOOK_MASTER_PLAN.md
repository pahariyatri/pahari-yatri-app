...
Seven chapters live: Understanding Parvati Valley, Kasol, Kalga, Pulga, Tosh, Kheerganga, Grahan. Remaining order: **Malana** next (needs the most editorial care of anything left) → Chalal, Rasol, Tulga, Bunbuni Pass, Waichin Valley, Sar Pass → then Manikaran Sahib and Mantalai Lake as the two "add more chapters" candidates worth pursuing.
