...
export default function About() {
  const jsonLd = {
    ...
    "description": "Pahari Yatri offers authentic, sustainable, and personalized trekking experiences across the Indian Himalayas. We specialize in spiritual yatras to sacred Himalayan peaks and destinations throughout the region.",
    "sameAs": [
    ...
    "address": {
      ...
      "addressLocality": "Himachal Pradesh", // You can keep this as your HQ location
      "addressCountry": "IN",
    }
  };
      ...
      <div className="relative bg-cover bg-center h-[40vh] sm:h-[50vh]" style={{ backgroundImage: "url('/static/images/pahari-yatri-banner.png')" }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-4 px-4">
          ...
          <p className="text-lg sm:text-xl text-gray-200 max-w-2xl">
            Welcome to Pahari Yatri, your gateway to transformative journeys across the majestic Indian Himalayas.
          </p>
        </div>
      </div>
        ...
        <div className="px-4 sm:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
          ...
          <section className="mb-12 text-center">
            ...
            <p className="text-lg sm:text-xl leading-relaxed">
              At Pahari Yatri, we envision a world where every trekker connects deeply with the untouched beauty and spiritual essence of the Indian Himalayas. Our mission is to bring the Himalayan experience to life through personalized treks and sacred yatras that rejuvenate body, mind, and soul.
            </p>
          </section>
          ...
          <section className="mb-12 text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl leading-relaxed">
              Pahari Yatri was born from my personal journey of self-discovery through the Himalayas. In 2018, during the Shrikhand Mahadev Yatra, I experienced a profound spiritual awakening. This sacred journey marked a turning point in my life, where I realized the Himalayas are not just physical challenges but sacred spaces that hold divine energy.
            </p>
            <p className="text-lg sm:text-xl leading-relaxed mt-4">
              Over the years, my passion led me to many sacred Himalayan peaks across regions like Himachal Pradesh, Uttarakhand, Ladakh, and beyond. These aren’t just trekking destinations—they are places where one can feel the divine presence of spiritual energy. Each yatra and trek is designed to deepen this connection.
            </p>
            <p className="text-lg sm:text-xl leading-relaxed mt-4">
            ...
            <p className="text-lg sm:text-xl leading-relaxed mt-4">
              In addition to trekking, Pahari Yatri also hosts stays in some of the Indian Himalayas’ untouched and unexplored locations. As a proud pahari and property owner, I invite you to experience our signature accommodations:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 text-left">
                ...
                <p className="mb-2">A peaceful retreat nestled in the pine forests of Kasauli, blending traditional pahari hospitality with modern comfort. Perfect for families, couples, and solo travelers seeking tranquility and easy access to Kasauli attractions.</p>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 text-left">
                ...
                <p className="mb-2">Experience the untouched beauty of Devidarh with our cozy mountain stay, surrounded by deodar forests and pristine nature. Ideal for explorers, trekkers, and those seeking a true offbeat Himalayan experience.</p>
          ...
          <section className="mb-12 text-center">
            ...
            <p className="text-lg sm:text-xl leading-relaxed mb-4">
              At Pahari Yatri, we are driven by three core values: <strong>Safety</strong>, <strong>Sustainability</strong>, and <strong>Personalization</strong>.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-left">
              ...
              <Card className="shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl h-full">
                ...
                <CardContent className="h-full flex flex-col justify-between">
                  <CardDescription className="text-center text-sm md:text-base">
                    We create unique experiences tailored to your needs, whether you are looking for a spiritual yatra or an adventurous trek.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
